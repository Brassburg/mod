...
package se.brassburg.world.inventory;
...
public class ATMMenu extends AbstractContainerMenu {
	...
	public ATMMenu(int id, Inventory inv, Container container) {
		super(BrassburgModMenus.ATM, id);
		this.entity = inv.player;
		this.world = inv.player.level;
		this.inventory = container;
		this.addSlot(new Slot(inventory, 0, 25, 44) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return BrassburgModItems.COIN == stack.getItem();
			}
		});
		this.addSlot(new Slot(inventory, 1, 133, 44) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
